/*! HTMLInclude v1.1.1 | MIT License | github.com/paul-browne/HTMLInclude */ /*! HTMLInclude v1.1.1 | MIT License | github.com/paul-browne/HTMLInclude */
!(function (l, d) {
  l.HTMLInclude ||
    (l.HTMLInclude = function () {
          ...
          4 == o.readyState &&
            ...
            e.forEach(function (t) {
              ...
              for (
                ...
                r[a].src ? (c.src = r[a].src) : (c.innerHTML = r[a].innerHTML),
      ...
      for (
        var e = {},
          n = d.querySelectorAll("[data-include]:not([data-in])"),
          i = n.length;
        i--;

      ) {
        var c = n[i].getAttribute("data-include"),
          o = n[i].getAttribute("data-lazy");
        n[i].setAttribute("data-in", ""),
          !o || (o && r(n[i], o))
            ? ((e[c] = e[c] || []), e[c].push(n[i]))
            : t(n[i], o);
      }
